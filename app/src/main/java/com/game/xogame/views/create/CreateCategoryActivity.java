...
public class CreateCategoryActivity extends AppCompatActivity {
    ...
    public void init(){
        ...
        arr.add(getString(R.string.category_myday));
        arr.add(getString(R.string.category_other));
